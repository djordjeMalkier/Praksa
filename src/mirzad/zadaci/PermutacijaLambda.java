...
public class PermutacijaLambda {
    public static void main(String[] args) {
        ...
        Map<Character,Integer> mapa = IntStream.
                range(0,permutationString.length()).
                boxed().
                collect(Collectors.toMap(permutationString.toLowerCase()::charAt, integer -> 1, (x, y) -> x+1));

        Map<Character,Integer> mapa2 = IntStream.
                range(0,inputString.length())
                .boxed().
                collect(Collectors.toMap(inputString.toLowerCase()::charAt, integer -> 1, (x, y) -> x+1));
